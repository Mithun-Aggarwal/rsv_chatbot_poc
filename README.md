...
3. Install dependencies:
   ...
   ```
4. (Optional) Add your OpenAI API key to enable free-text classification:
   ```bash
...
## Quick test
To verify the code compiles in your environment without running the web app, you can run:
```bash
python -m compileall .
```
